...
<head>
    ...
    <script type="text/javascript" src="/js/scriptEditDorm.js"></script>
    <style type="text/css">
        .modal-content{
            overflow: hidden;
        }
                ...
                <div id="glyph-menu" class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav pull-left">
                        ...
                        @else
                            ...
                            <li><a href="{{ url('/owner/notifications')}}" type="button">Notifications <span class="badge">{{Auth::user()->unreadNotifications->count()}}</span > </a></li>
                            @else
